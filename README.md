...
我是一名初入行的開發者，現為悉尼大學計算機科學碩士在讀（課程預計 2025 年 12 月完成）；此前獲得阿爾戈馬大學計算機科學學士（2023，榮譽畢業）。重視工程紀律：型別安全、單元/整合測試、CI/CD、代碼審查、可觀測性/日誌與清晰文件。

- 核心技術棧：Python、Java、TypeScript
- 常用框架：Spring Boot、NestJS、Angular
...
聯絡：GitHub https://github.com/Jackela · 網站 https://jackela.github.io · 電郵 Jackkong29@Gmail.com

简体中文 内地

我是初入行的开发者，现为悉尼大学计算机科学硕士在读（课程预计 2025 年 12 月完成）；此前获得阿尔戈马大学计算机科学学士（2023，荣誉毕业）。强调工程纪律：类型安全、单元/集成测试、CI/CD、代码评审、可观测性/日志与清晰文档。

- 核心技术栈：Python、Java、TypeScript
- 常用框架：Spring Boot、NestJS、Angular
